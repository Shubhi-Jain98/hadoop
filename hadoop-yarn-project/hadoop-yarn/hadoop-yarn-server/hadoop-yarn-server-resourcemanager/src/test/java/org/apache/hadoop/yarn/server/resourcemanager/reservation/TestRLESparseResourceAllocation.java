...
public class TestRLESparseResourceAllocation {
  ...
  public void testMergesubtractTestNonNegative() throws PlanningException {
    ...
    // try with same setting and rleA generated by merge operation
    a.put(10L, Resource.newInstance(10, 5));
    ...
    rleA = RLESparseResourceAllocation.merge(new DefaultResourceCalculator(),
        Resources.clone(Resource.newInstance(10, 5)), rleA, rleB,
        RLEOperator.min, 0, 60);
